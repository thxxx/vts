...
class IntegralState:
    ...
    def default(
        *,
        ...
        return IntegralState(method_order, almost_zero)
...
class IntegralController(AdaptiveStepSizeController[IntegralState]):
    ...
    def initial_state(self, method_order: int, problem: InitialValueProblem):
    ...
    def init(
        ...
        *,
    ...
    ) -> tuple[TimeTensor, IntegralState, DataTensor]:
        ...
        return dt0, self.initial_state(method_order, problem), f0
    ...
    def adapt_step_size(
        ...
        state: IntegralState,
        stats: dict[str, Tensor],
    ) -> tuple[AcceptTensor, TimeTensor, IntegralState, StatusTensor]:
    ...
    def _select_initial_step(
        ...
        y1 = y0 + einsum(direction, dt0, f0, "b, b, b ... -> b ...")
        f1 = term.vf(
