...
class AudioBox(nn.Module):
    def __init__(
        ...
        # self.to_input = nn.Linear(audio_dim * 2 + 16, audio_dim)
    ...
    def cfg(
        ...
        voice_enc = repeat(voice_enc, "b ... -> (r b) ...", r=2)
    ...
    def forward(
        ...
        context = torch.cat((voice_enc, context), dim=-1)
        context = self.to_input(context)
