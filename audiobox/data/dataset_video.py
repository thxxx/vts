...
class AudioDataset(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        return latents, video_latents, audio_mask, desc, duration
    ...
    def collate(
        ...
        audio_embed, video_latents, audio_masks, descs, durations = zip(*filter_batches)
        ...
        return torch.stack(audio_embed), torch.stack(video_latents), torch.stack(audio_masks), input_ids, attention_mask
