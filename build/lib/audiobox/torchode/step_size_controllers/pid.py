...
class PIDState:
    ...
    def default(
        *,
        ...
        return PIDState(method_order, default_ratio, default_ratio, almost_zero)
...
class PIDController(AdaptiveStepSizeController[PIDState]):
    ...
    ) -> tuple[TimeTensor, PIDState, DataTensor]:
    ...
    def adapt_step_size(
        ...
        state: PIDState,
        stats: dict[str, Tensor],
    ) -> tuple[AcceptTensor, TimeTensor, PIDState, StatusTensor]:
